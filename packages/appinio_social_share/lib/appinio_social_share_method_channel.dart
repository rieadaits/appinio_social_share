...
class MethodChannelAppinioSocialShare extends AppinioSocialSharePlatform {
  ...
  @override
  Future<String> shareToInstagramDirect({String? message, String? filePath}) async {
    return ((await methodChannel
            .invokeMethod<String>(instagramDirect, {"imagePath": filePath, "message": message})) ??
        "");
  }
  ...
  @override
  Future<String> shareToMessenger({String? message, String? filePath}) async {
    return ((await methodChannel.invokeMethod<String>(
            messenger, {"imagePath": filePath, "message": message})) ??
        "");
  }
