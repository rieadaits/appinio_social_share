...
class AppinioSocialShare {
  ...
  Future<String> shareToInstagramDirect({String? message, String? filePath}) {
    return AppinioSocialSharePlatform.instance.shareToInstagramDirect(message: message, filePath: filePath);
  }
  ...
  Future<String> shareToMessenger({String? message, String? filePath}) {
    return AppinioSocialSharePlatform.instance.shareToMessenger(message: message, filePath: filePath);
  }
